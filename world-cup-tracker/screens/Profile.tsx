...
export const Profile: React.FC = () => {
  const [profile, setProfile] = useState<UserProfile>({ name: 'Alex Morgan', team: 'Argentina 🇦🇷' });
  ...
  const handleSaveProfile = () => {
    ...
    const newProfile = { name: editName, team: editTeam };
        ...
        <main className="flex-1 w-full max-w-md mx-auto">
            <section className="flex flex-col items-center py-8 px-4">
                <div className="text-center">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-sm mt-3">Member since 2022</p>
                </div>
            </section>
            ...
            <section className="mt-8">
             ...
             <section className="px-4 mt-10">
                <button className="w-full bg-white dark:bg-[#2a1d31] text-red-500 font-bold py-4 rounded-xl shadow-sm active:scale-[0.98] transition-all flex items-center justify-center gap-2 border border-red-500/10">
