                ...
                <div className="px-6 py-8 flex flex-col items-center">
                    ...
                    <div className="flex flex-col gap-3 w-full mt-8">
                        <button
                            ...
                            className="flex cursor-pointer items-center justify-center rounded-xl h-14 px-5 bg-primary hover:bg-[#b82dfc] transition-colors text-white text-lg font-bold w-full shadow-lg shadow-primary/20 disabled:opacity-50"
                        >
                            {isRestarting ? (
                                <div className="flex items-center gap-2">
