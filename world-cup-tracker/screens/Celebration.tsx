    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-[#1c1022] text-white overflow-hidden">
        ...
        <main className="relative flex-1 flex flex-col items-center justify-center px-4 pb-20">
            ...
            <div className="w-full max-w-md mt-10">
                <button 
                    onClick={onRestart}
                    className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-5 px-6 rounded-full shadow-lg shadow-primary/30 transition-all flex items-center justify-center gap-2"
                >
                    Start New Campaign
                </button>
            </div>
